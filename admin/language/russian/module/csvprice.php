<?php
// Heading
$_['heading_title']    = 'Импорт/Экспорт прайс-листа в CSV';
...
$_['entry_import_help']		= 'Исходный файл должен быть в кодировке UTF-8!';
$_['entry_export']		= 'Экспорт:';
$_['entry_category']	= 'Экспорт из категорий:';
$_['entry_category_help']	= 'Если категории не выбраны - экспортирует все товары, <br>файл выгружается в кодировке UTF-8!';
