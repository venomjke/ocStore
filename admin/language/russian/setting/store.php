...
$_['entry_ssl']			= 'SSL URL:<br /><span class="help">SSL ссылка к магазину. Убедитесь, что она оканчивается на символ \'/\'. Например: http://www.yourdomain.com/path/<br /><br />Не используйте директории для создания нового магазина. Необходимо использовать поддомен или новый домен.</span>';
...
$_['entry_tax']			= 'Включить работу с налогами:<br /><span class="help">Включает автоматический подсчёт цены с учётом налога и отображение её как основной.<br />Так же включает отображение цены «без НДС»</span>';
