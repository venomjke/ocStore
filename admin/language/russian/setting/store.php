...
// Entry
$_['entry_url']					= 'URL магазина:<br /><span class="help">Включая полный URL к магазину. Убедитесь, что в конце стоит \'/\'. Например: http://wwww.yourdomain.com/path/</span>';
$_['entry_ssl']                                 = 'SSL URL:<br /><span class="help">SSL ссылка к магазину. Убедитесь, что в конце стоит \'/\'. Например: http://www.yourdomain.com/path/<br /><br />Не используйте директории для создания нового магазина. Необходимо использовать поддомен или новый домен.</span>';
