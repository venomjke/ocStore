...
// Entry
$_['entry_url']					= 'URL магазина:<br /><span class="help">Включая полный URL к магазину. Убедитесь, что в конце стоит \'/\'. Например: http://'.$_SERVER['SERVER_NAME'].'/<br /><br />Не используйте директории для создания нового магазина. Необходимо использовать поддомен или новый домен.</span>';
$_['entry_ssl']                                 = 'SSL URL:<br /><span class="help">SSL ссылка к магазину. Убедитесь, что в конце стоит \'/\'. Например: https://'.$_SERVER['SERVER_NAME'].'/<br /><br />Не используйте директории для создания нового магазина. Необходимо использовать поддомен или новый домен.</span>';
