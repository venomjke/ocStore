...
$_['entry_complete_status']		= 'Статус готового заказа:<br /><span class="help">Статус заказа, который он должен получить для получения клиентом доступа к скачиваемому товару или подарочному сертификату (в случае торговли таковыми).</span>';
