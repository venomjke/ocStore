...
<br><input type="submit" name="submit" value="Рассчитать">
          ...
          <tr>
            <td class="center" colspan="8"><?php echo "<br><small><b>Автор и разработчик: <font color=green>Эльхан Исаев</font></b> &copy; 14.04.12* <br /> *дополнения от 21.04.12 <br /> *дополнения от 27.04.12 <br /> *дополнения от 01.05.12</small> <br>Хочешь отблагодарить автора? кинь денюшку на баланс :) 89241133333 (Мегафон Дальний Восток)"; ?></td>
          </tr>
