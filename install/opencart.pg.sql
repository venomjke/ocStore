...
CREATE INDEX "oc_address_key_customer_id" ON "oc_address" ("customer_id");
...
CREATE INDEX "oc_category_key_parent_id" ON "oc_category" ("parent_id");
CREATE INDEX "oc_category_key_sort_order" ON "oc_category" ("sort_order");
CREATE INDEX "oc_category_key_status" ON "oc_category" ("status");
...
CREATE INDEX "oc_category_description_key_name" ON "oc_category_description" ("name");
...
(18, 1, 'Ноутбуки', '','', ''),
(28, 1, 'Мониторы', '', '', ''),
(20, 1, 'Стационарные компьютеры', '', 'Пример описания категории', E'&lt;p&gt;\r\n	Пример текстового описания категории&lt;/p&gt;\r\n'),
(34, 1, 'MP3 Плееры', '', '', ''),
(33, 1, 'Камеры', '', '', ''),
(32, 1, 'Веб-камеры', '', '', ''),
(31, 1, 'Сканеры', '', '', ''),
...
CREATE TABLE "oc_country" (
  ...
  "iso_code_2" varchar(3) NOT NULL DEFAULT '',
  "iso_code_3" varchar(3) NOT NULL DEFAULT '',
  "address_format" text NOT NULL,
  "postcode_required" smallint NOT NULL DEFAULT '0',
  "status" smallint NOT NULL DEFAULT '1',
...
(189, 'Словакия', 'SK', 'SVK', E'{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city} {postcode}\r\n{zone}\r\n{country}', 1),
...
(223, 'Соединенные Штаты Америки', 'US', 'USA', E'{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}', 1),
...
--
-- Дамп данных таблицы "oc_coupon_description"
--

INSERT INTO "oc_coupon_description" ("coupon_id", "language_id", "name", "description") VALUES
(4, 1, 'Купон (-10%)', 'Скидка 10%'),
(5, 1, 'Купон (бесплатная доставка)', 'Бесплатная доставка'),
(6, 1, 'Купон (-10.00)', 'Фиксированная скидка');
...
CREATE TABLE "oc_coupon_product" (
  "coupon_product_id" bigserial not null,
  "coupon_id" bigint NOT NULL,
...
INSERT INTO "oc_extension" ("type", "key") VALUES
('payment', 'cod'),
('total', 'shipping'),
('total', 'sub_total'),
('total', 'tax'),
...
CREATE TABLE "oc_geo_zone" (
  "geo_zone_id" bigserial not null,
...
CREATE TABLE "oc_information" (
  "information_id" bigserial not null,
  "sort_order" smallint NOT NULL DEFAULT '0',
  "status" smallint NOT NULL DEFAULT '1',
...
(5, 1, 'Условия соглашения', E'&lt;p&gt;\r\n	Условия соглашения&lt;/p&gt;\r\n'),
(3, 1, 'Политика Безопасности', E'&lt;p&gt;\r\n	Политика Безопасности&lt;/p&gt;\r\n'),
(4, 1, 'О нас', E'&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n');
...
CREATE INDEX "oc_language_key_name" ON "oc_language" ("name");
...
CREATE TABLE "oc_length_class" (
  "length_class_id" bigserial not null,
...
CREATE TABLE "oc_order" (
  ...
  "customer_group_id" bigint NOT NULL DEFAULT '0',
  "firstname" varchar(32) NOT NULL DEFAULT '',
  ...
  "payment_zone_id" bigint NOT NULL,
  "payment_country" varchar(128) NOT NULL,
  "payment_country_id" bigint NOT NULL,
  "payment_address_format" text NOT NULL,
  "payment_method" varchar(128) NOT NULL DEFAULT '',
  "comment" text NOT NULL,
  "total" decimal(15,4) NOT NULL DEFAULT '0.0000',
  "order_status_id" bigint NOT NULL DEFAULT '0',
  "language_id" bigint NOT NULL,
...
CREATE INDEX "oc_order_key_order_status_id" ON "oc_order" ("order_status_id");
...
CREATE TABLE "oc_order_download" (
  "order_download_id" bigserial not null,
...
CREATE TABLE "oc_order_option" (
  "order_option_id" bigserial not null,
  "order_id" bigint NOT NULL,
  "order_product_id" bigint NOT NULL,
  "product_option_value_id" bigint NOT NULL DEFAULT '0',
...
CREATE INDEX "oc_order_product_key_product_id" ON "oc_order_product" ("product_id");
CREATE INDEX "oc_order_product_key_order_id" ON "oc_order_product" ("order_id");
...
CREATE TABLE "oc_order_total" (
  "order_total_id" bigserial not null,
  "order_id" bigint NOT NULL,
  "title" varchar(255) NOT NULL DEFAULT '',
...
CREATE INDEX "oc_order_total_key_orders_id" ON "oc_order_total" ("order_id");
...
CREATE TABLE "oc_product" (
  ...
  "length_class_id" bigint NOT NULL DEFAULT '0',
...
CREATE INDEX "oc_product_key_status" ON "oc_product" ("status");
...
(28, 'Товар 1', '', '', 10, 7, 'data/htc_touch_hd_1.jpg', 5, 1, '16490.0000', 9, '2009-02-03', '146.40', 2, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 16:06:50', '2010-03-25 14:37:23', 0),
(29, 'Товар 2', '', '', 10, 6, 'data/palm_treo_pro_1.jpg', 6, 1, '21099.0000', 9, '2009-02-03', '133.00', 2, '0.00', '0.00', '0.00', 3, 1, '2009-02-03 16:42:17', '2010-03-25 14:38:01', 0),
(30, 'Товар 3', '', '', 10, 6, 'data/canon_eos_5d_1.jpg', 9, 1, '4868.8600', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 16:59:00', '2010-03-25 14:37:11', 0),
(31, 'Товар 4', '', '', 50, 6, 'data/nikon_d300_1.jpg', 0, 1, '52900.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 3, 1, '2009-02-03 17:00:10', '2010-03-25 14:37:54', 0),
(32, 'Товар 5', '', '', 10, 6, 'data/ipod_touch_1.jpg', 8, 1, '13390.0000', 9, '2009-02-03', '5.00', 1, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 17:07:26', '2010-03-25 14:36:51', 0),
(33, 'Товар 6', '', '', 10, 6, 'data/samsung_syncmaster_941bw.jpg', 0, 1, '5000.0000', 9, '2009-02-03', '5.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 17:08:31', '2010-03-25 14:35:49', 1),
(34, 'Товар 7', '', '', 10, 6, 'data/ipod_shuffle_1.jpg', 8, 1, '1465.0000', 9, '2009-02-03', '5.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 18:07:54', '2010-03-25 14:36:38', 0),
(35, 'Товар 8', '', '', 10, 5, '', 0, 0, '100.0000', 9, '2009-02-03', '5.00', 1, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 18:08:31', '2010-03-25 14:38:06', 0),
(36, 'Товар 9', '', '', 8, 6, 'data/ipod_nano_1.jpg', 8, 0, '8999.0000', 9, '2009-02-03', '5.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 18:09:19', '2010-03-25 14:36:32', 0),
(40, 'Товар 11', '', '', 7, 5, 'data/iphone_1.jpg', 8, 1, '26990.0000', 9, '2009-02-03', '10.00', 1, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 21:07:12', '2010-03-25 14:36:23', 0),
(41, 'Товар 14', '', '', 100, 5, 'data/imac_1.jpg', 8, 0, '49990.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, '2009-02-03 21:07:26', '2010-03-25 14:36:06', 0),
(42, 'Товар 15', '', '', 100, 5, 'data/apple_cinema_30.jpg', 8, 1, '87530.0000', 0, '2009-02-04', '12.50', 2, '1.00', '2.00', '3.00', 2, 1, '2009-02-03 21:07:37', '2010-03-29 15:05:00', 0),
(43, 'Товар 16', '', '', 9, 5, 'data/macbook_1.jpg', 8, 0, '43790.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 21:07:49', '2010-03-25 14:37:30', 0),
(44, 'Товар 17', '', '', 10, 5, 'data/macbook_air_1.jpg', 8, 1, '66490.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 21:08:00', '2010-03-25 14:37:36', 0),
(45, 'Товар 18', '', '', 99, 5, 'data/macbook_pro_1.jpg', 8, 1, '52790.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 21:08:17', '2010-03-25 14:37:40', 0),
(46, 'Товар 19', '', '', 8, 5, 'data/sony_vaio_1.jpg', 10, 1, '50000.0000', 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 2, 1, '2009-02-03 21:08:29', '2010-03-25 14:35:59', 0),
...
CREATE INDEX "oc_product_description_key_name" ON "oc_product_description" ("name");
...
CREATE TABLE "oc_product_discount" (
  "product_discount_id" bigserial not null,
  "product_id" bigint NOT NULL,
  "customer_group_id" bigint NOT NULL,
  "quantity" smallint NOT NULL DEFAULT '0',
...
CREATE INDEX "oc_product_discount_key_product_id" ON "oc_product_discount" ("product_id");
...
CREATE INDEX "oc_product_image_key_product_id" ON "oc_product_image" ("product_id");
...
CREATE TABLE "oc_product_option" (
  "product_option_id" bigserial not null,
  "product_id" bigint NOT NULL,
  "sort_order" smallint NOT NULL DEFAULT '0',
  PRIMARY KEY ("product_option_id")
);

CREATE INDEX "oc_product_option_key_product_id" ON "oc_product_option" ("product_id");
...
--
-- Дамп данных таблицы "oc_product_option_description"
--
...
CREATE TABLE "oc_product_option_value" (
  "product_option_value_id" bigserial not null,
  "product_option_id" bigint NOT NULL,
  "product_id" bigint NOT NULL,
  "quantity" smallint NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы "oc_product_option_value_description"
--
...
CREATE TABLE "oc_product_special" (
  "product_special_id" bigserial not null,
  "product_id" bigint NOT NULL,
  "customer_group_id" bigint NOT NULL,
  "priority" integer NOT NULL DEFAULT '1',
  "price" decimal(15,4) NOT NULL DEFAULT '0.0000',
...
CREATE INDEX "oc_product_special_product_id" ON "oc_product_special" ("product_id");
...
CREATE INDEX "oc_review_key_product_id" ON "oc_review" ("product_id");
...
INSERT INTO "oc_setting" ("group", "key", "value") VALUES
('coupon', 'coupon_sort_order', '4'),
('shipping', 'shipping_sort_order', '3'),
('shipping', 'shipping_status', '1'),
('cod', 'cod_sort_order', '1'),
('sub_total', 'sub_total_sort_order', '1'),
('cod', 'cod_status', '1'),
('cod', 'cod_geo_zone_id', '0'),
('coupon', 'coupon_status', '1'),
('sub_total', 'sub_total_status', '1'),
('cod', 'cod_order_status_id', '1'),
('tax', 'tax_status', '1'),
('tax', 'tax_sort_order', '5'),
('total', 'total_sort_order', '6'),
('total', 'total_status', '1'),
('category', 'category_sort_order', '1'),
('category', 'category_status', '1'),
('information', 'information_sort_order', '3'),
('information', 'information_status', '1'),
('information', 'information_position', 'left'),
('manufacturer', 'manufacturer_sort_order', '2'),
('manufacturer', 'manufacturer_status', '1'),
('bestseller', 'bestseller_sort_order', '3'),
('bestseller', 'bestseller_status', '1'),
('bestseller', 'bestseller_position', 'right'),
('bestseller', 'bestseller_limit', '10'),
('featured', 'featured_limit', '5'),
('featured', 'featured_position', 'right'),
('featured', 'featured_status', '1'),
('featured', 'featured_sort_order', '5'),
('cart', 'cart_status', '1'),
('category', 'category_position', 'left'),
('manufacturer', 'manufacturer_position', 'left'),
...
('config', 'config_mail_protocol', 'mail'),
('config', 'config_image_cart_height', '75'),
('config', 'config_image_cart_width', '75'),
('config', 'config_image_related_height', '120'),
('config', 'config_image_related_width', '120'),
('config', 'config_image_additional_height', '150'),
('config', 'config_image_additional_width', '150'),
('config', 'config_image_product_height', '120'),
('config', 'config_image_product_width', '120'),
('config', 'config_image_category_height', '120'),
('config', 'config_image_category_width', '120'),
('config', 'config_image_popup_height', '500'),
('config', 'config_image_popup_width', '500'),
('config', 'config_image_thumb_height', '250'),
('config', 'config_image_thumb_width', '250'),
('config', 'config_icon', 'data/cart.png'),
('config', 'config_logo', 'data/logo.png'),
('config', 'config_shipping_session', '0'),
('config', 'config_cart_weight', '1'),
('config', 'config_catalog_limit', '20'),
('config', 'config_admin_limit', '20'),
('config', 'config_download_status', '5'),
('config', 'config_download', '1'),
('config', 'config_stock_status_id', '5'),
('config', 'config_order_status_id', '1'),
('config', 'config_stock_subtract', '0'),
('config', 'config_stock_checkout', '0'),
('config', 'config_stock_check', '1'),
('config', 'config_stock_display', '0'),
('config', 'config_checkout_id', '5'),
('config', 'config_account_id', '3'),
('config', 'config_guest_checkout', '1'),
('config', 'config_customer_approval', '0'),
...
('config', 'config_zone_id', '3563'),
('config', 'config_language', 'ru'),
('config', 'config_country_id', '176'),
('config', 'config_description_1', E'&lt;p&gt;\r\n	Добро пожаловать в Мой магазин!&lt;/p&gt;\r\n'),
('config', 'config_template', 'default'),
('config', 'config_meta_description', 'Мой магазин'),
('config', 'config_title', 'Мой магазин'),
('config', 'config_fax', ''),
('config', 'config_telephone', '123456789'),
('config', 'config_owner', 'Ваше имя'),
('config', 'config_address', 'Адрес 1'),
('config', 'config_email', 'mail@myopencart.ru'),
('config', 'config_url', 'http://localhost/'),
('config', 'config_name', 'Мой магазин'),
('config', 'config_smtp_port', '25'),
('config', 'config_smtp_timeout', '5'),
('config', 'config_account_mail', '0'),
('config', 'config_alert_mail', '1'),
('config', 'config_ssl', '0'),
('config', 'config_encryption', '12345'),
('config', 'config_seo_url', '0'),
('config', 'config_compression', '0'),
('config', 'config_error_display', '1'),
('config', 'config_error_log', '1'),
('config', 'config_invoice_id', '1'),
('config', 'config_invoice_prefix', 'INV-2011-00'),
('config', 'config_review', '1'),
('latest', 'latest_limit', '8'),
('latest', 'latest_position', 'home'),
('latest', 'latest_status', '1'),
('latest', 'latest_sort_order', '0'),
('config', 'config_error_filename', 'error.txt'),
('blinks', 'blinks_position', 'right'),
('blinks', 'blinks_status', '1'),
('blinks', 'blinks_sort_order', '10'),
('blinks', 'blinks_links', E'&lt;a href=&quot;http://myopencart.ru&quot;&gt;myOpenCart.ru&lt;/a&gt; \r\n &lt;a href=&quot;http://myopencart.ru/wiki/&quot;&gt;Документация&lt;/a&gt; \r\n &lt;a href=&quot;http://opencartforum.ru&quot;&gt;Форум поддержки&lt;/a&gt;  \r\n &lt;a href=&quot;http://domenam.ru&quot;&gt;Хостинг для OpenCart&lt;/a&gt;');
...
CREATE TABLE "oc_stock_status" (
  "stock_status_id" bigserial not null,
  "language_id" bigint NOT NULL,
  "name" varchar(32) NOT NULL,
...
CREATE TABLE "oc_store" (
  ...
  "customer_group_id" bigint NOT NULL,
  "customer_price" smallint NOT NULL,
  "customer_approval" smallint NOT NULL,
  "guest_checkout" smallint NOT NULL,
  "account_id" bigint NOT NULL DEFAULT '0',
  "checkout_id" bigint NOT NULL DEFAULT '0',
  "stock_display" smallint NOT NULL,
  "stock_check" smallint NOT NULL,
  "stock_checkout" smallint NOT NULL,
  "order_status_id" bigint NOT NULL,
  "logo" varchar(255) NOT NULL,
  "icon" varchar(255) NOT NULL,
  "image_thumb_width" integer NOT NULL,
  "image_thumb_height" integer NOT NULL,
  "image_popup_width" integer NOT NULL,
  "image_popup_height" integer NOT NULL,
  "image_category_width" integer NOT NULL,
  "image_category_height" integer NOT NULL,
  "image_product_width" integer NOT NULL,
  "image_product_height" integer NOT NULL,
  "image_additional_width" integer NOT NULL,
  "image_additional_height" integer NOT NULL,
  "image_related_width" integer NOT NULL,
  "image_related_height" integer NOT NULL,
  "image_cart_width" integer NOT NULL,
  "image_cart_height" integer NOT NULL,
  "ssl" smallint NOT NULL,
  "catalog_limit" smallint NOT NULL DEFAULT '12',
  "cart_weight" smallint NOT NULL,
...
--
-- Дамп данных таблицы "oc_store_description"
--
...
CREATE TABLE "oc_tax_class" (
  "tax_class_id" bigserial not null,
  "title" varchar(32) NOT NULL DEFAULT '',
  "description" varchar(255) NOT NULL DEFAULT '',
  "date_added" timestamp NOT NULL DEFAULT '0001-01-01 00:00:00',
  "date_modified" timestamp NOT NULL DEFAULT '0001-01-01 00:00:00',
...
CREATE TABLE "oc_tax_rate" (
  "tax_rate_id" bigserial not null,
  "geo_zone_id" bigint NOT NULL DEFAULT '0',
  "tax_class_id" bigint NOT NULL,
  "priority" integer NOT NULL DEFAULT '1',
...
CREATE TABLE "oc_url_alias" (
  "url_alias_id" bigserial not null,
...
CREATE TABLE "oc_weight_class" (
  "weight_class_id" bigserial not null,
...
(916, 57, 'VK', 'Vejle', 1),
(917, 57, 'VJ', E'Vestj&aelig;lland', 1),
(918, 57, 'VB', 'Viborg', 1),
...
(1172, 74, '58', E'Ni&egrave;vre', 1),
(1173, 74, '59', 'Nord', 1),
(1174, 74, '60', 'Oise', 1),
(1175, 74, '61', 'Orne', 1),
(1176, 74, '62', 'Pas de Calais', 1),
(1177, 74, '63', E'Puy de D&ocirc;me', 1),
(1178, 74, '64', E'Pyr&eacute;n&eacute;es Atlantiques', 1),
(1179, 74, '65', E'Hautes Pyr&eacute;n&eacute;es', 1),
(1180, 74, '66', E'Pyr&eacute;n&eacute;es Orientales', 1),
(1181, 74, '67', 'Bas Rhin', 1),
(1182, 74, '68', 'Haut Rhin', 1),
(1183, 74, '69', E'Rh&ocirc;ne', 1),
(1184, 74, '70', E'Haute Sa&ocirc;ne', 1),
(1185, 74, '71', E'Sa&ocirc;ne et Loire', 1),
(1186, 74, '72', 'Sarthe', 1),
(1187, 74, '73', 'Savoie', 1),
...
(1193, 74, '79', E'Deux S&egrave;vres', 1),
(1194, 74, '80', 'Somme', 1),
(1195, 74, '81', 'Tarn', 1),
(1196, 74, '82', 'Tarn et Garonne', 1),
(1197, 74, '83', 'Var', 1),
(1198, 74, '84', 'Vaucluse', 1),
(1199, 74, '85', E'Vend&eacute;e', 1),
(1200, 74, '86', 'Vienne', 1),
...
(1254, 81, 'BAW', E'Baden-W&uuml;rttemberg', 1),
...
(1269, 81, 'THE', E'Th&uuml;ringen', 1),
...
(2649, 171, 'AC', E'A&ccedil;ores', 1),
(2650, 171, 'AV', 'Aveiro', 1),
(2651, 171, 'BE', 'Beja', 1),
(2652, 171, 'BR', 'Braga', 1),
(2653, 171, 'BA', E'Bragan&ccedil;a', 1),
(2654, 171, 'CB', 'Castelo Branco', 1),
(2655, 171, 'CO', 'Coimbra', 1),
(2656, 171, 'EV', E'&Eacute;vora', 1),
(2657, 171, 'FA', 'Faro', 1),
...
(2663, 171, 'PR', 'Porto', 1),
(2664, 171, 'SA', E'Santar&eacute;m', 1),
(2665, 171, 'SE', E'Set&uacute;bal', 1),
...
(3075, 203, 'W', 'Dalama', 1),
(3076, 203, 'X', E'G&auml;vleborg', 1),
(3077, 203, 'I', 'Gotland', 1),
(3078, 203, 'N', 'Halland', 1),
(3079, 203, 'Z', E'J&auml;mtland', 1),
(3080, 203, 'F', E'J&ouml;nk&ouml;ping', 1),
(3081, 203, 'H', 'Kalmar', 1),
(3082, 203, 'G', 'Kronoberg', 1),
(3083, 203, 'BD', 'Norrbotten', 1),
(3084, 203, 'T', E'&Ouml;rebro', 1),
(3085, 203, 'E', E'&Ouml;sterg&ouml;tland', 1),
(3086, 203, 'M', E'Sk&aring;ne', 1),
(3087, 203, 'D', E'S&ouml;dermanland', 1),
(3088, 203, 'AB', 'Stockholm', 1),
(3089, 203, 'C', 'Uppsala', 1),
(3090, 203, 'S', E'V&auml;rmland', 1),
(3091, 203, 'AC', E'V&auml;sterbotten', 1),
(3092, 203, 'Y', E'V&auml;sternorrland', 1),
(3093, 203, 'U', E'V&auml;stmanland', 1),
(3094, 203, 'O', E'V&auml;stra G&ouml;taland', 1),
...
(3102, 204, 'GE', E'Gen&egrave;ve', 1),
(3103, 204, 'GL', 'Glarus', 1),
(3104, 204, 'GR', E'Graub&uuml;nden', 1),
(3105, 204, 'JU', 'Jura', 1),
(3106, 204, 'LU', 'Luzern', 1),
(3107, 204, 'NE', E'Neuch&acirc;tel', 1),
...
CREATE TABLE "oc_zone_to_geo_zone" (
  "zone_to_geo_zone_id" bigserial not null,
  "country_id" bigint NOT NULL,
  "zone_id" bigint NOT NULL DEFAULT '0',
