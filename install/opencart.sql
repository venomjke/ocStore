...
CREATE TABLE `oc_order_fraud` (
  ...
  `high_risk_password` varchar(3) COLLATE uf8_bin NOT NULL,
...
(9, 'Налоги',   'Облагаемые налогом', '2009-01-06 23:21:53', '2011-09-23 14:07:50'),
(10, 'Загружаемые товары', 'Загружаемые', '2011-09-21 22:19:39', '2011-09-22 10:27:36');
